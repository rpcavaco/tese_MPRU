...
Na prática, o Estado deveria ser impedido, ou auto regular-se, não cobrando portagens de forma a contribuir significativamente para o congestionamento de vias alternativas. Em muitos casos isso corresponderá à pura e simples impossibilidade da cobrança de portagem, independentemente do valor cobrado. Se efetivamente o Estado não tem como financiar, do seu orçamento, a autoestrada e precisa de proveitos adicionais para custear os investimentos envolvidos, então temos duas hipóteses:
